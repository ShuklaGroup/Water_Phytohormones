...
import pickle
data = np.load('tica_traj_normalized.npy', allow_pickle=True)
dat1 = []
dat2 = []
...
cl = pickle.load(open('../MSMs/clustering_tica_normalized_inverse.pkl','rb'))
msm = pickle.load(open('../MSMs/MSM30.pkl','rb'))

counts, dat1, dat2 = free_energy_data(dat1,dat2,cl,msm)

np.save("data_x.npy", dat1)
np.save("data_y.npy", dat2)
