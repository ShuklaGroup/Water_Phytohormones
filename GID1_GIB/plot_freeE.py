...
c=ax0.contourf(energy, np.linspace(0, 5, 21), origin='lower', extent=[xmin, xmax, ymin, ymax], cmap='jet')

ax0.set_xlim(xmin, xmax)
ax0.set_ylim(ymin, ymax)
ax0.set_xticks((-3, -2, -1, 0, 1, xmax))
ax0.set_yticks((ymin, -2,  0, 2, ymax))
ax0.set_xlabel(r'tIC 1 (a.u.)', fontweight="bold")
ax0.set_ylabel(r'tIC 2 (a.u.)', fontweight="bold")
cbar = plt.colorbar(c,ticks=[0,1,2,3,4,5])
...
plt.tight_layout()
plt.savefig("tIC1-tIC2-path.png", dpi=300, bbox_inches='tight')
